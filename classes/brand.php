...
<?php
	...
	class brand
	{
		...
		public function getbrand_Asus(){
			$query = "SELECT * FROM tbl_product where brandId= '8'";
			$result = $this->db->select($query);
			return $result;
		}
		public function getbrand_MSI(){
			$query = "SELECT * FROM tbl_product where brandId= '6' ";
			$result = $this->db->select($query);
			return $result;
		}
		public function getbrand_Works(){
			$query = "SELECT * FROM tbl_product where catId= '23' ";
			$result = $this->db->select($query);
			return $result;
		}
				public function getbrand_PC(){
			$query = "SELECT * FROM tbl_product where catId= '22' ";
			$result = $this->db->select($query);
			return $result;
		}
	}
